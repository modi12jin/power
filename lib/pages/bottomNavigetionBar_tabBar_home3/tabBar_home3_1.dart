...
class tabBar_home3_1 extends StatelessWidget {
  @override
...
body: Container(
  ...
  child:  GridView.count(
      ...
      children: <Widget>[
                 ...
                 InkWell(
          child:MyGridView (image: "Icon-64 (4).png",teks: "初级滤波电容"),
    onTap: () {
        Navigator.push(
              context,
    ...
    onTap: () {
        Navigator.push(
              ...
              InkWell(
          child:MyGridView (image: "Icon-64 (5).png",teks: "吸收二极管"),
    onTap: () {
        Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => navigator_tabBar3_1_1(),),
    ...
    onTap: () {
        Navigator.push(
             ...
             InkWell(
          child:MyGridView (image: "Icon-64 (5).png",teks: "次级二极管"),
    onTap: () {
        Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => navigator_tabBar3_1_1(),),
