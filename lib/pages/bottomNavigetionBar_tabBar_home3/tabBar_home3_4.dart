...
class tabBar_home3_4 extends StatelessWidget {
  @override
...
body: Container(
  ...
  child:  GridView.count(
      ...
      children: <Widget>[
            ...
            InkWell(
          child:MyGridView (image: "Icon-64 (4).png",teks: "MOS管"),
    onTap: () {
        Navigator.push(
              context,
    ...
    onTap: () {
        Navigator.push(
              ...
              MaterialPageRoute(builder: (context) => navigator_tabBar3_1_1(),),
                ...
                InkWell(
          child:MyGridView (image: "Icon-64 (4).png",teks: "电容"),
    onTap: () {
        Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => navigator_tabBar3_1_1(),),
    ...
    onTap: () {
        Navigator.push(
              ...
              MaterialPageRoute(builder: (context) => navigator_tabBar3_1_1(),),
                  ...
                  InkWell(
          child:MyGridView (image: "Icon-64 (4).png",teks: "变压器"),
    onTap: () {
        Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => navigator_tabBar3_1_1(),),
                  ...
                  InkWell(
          child:MyGridView (image: "Icon-64 (4).png",teks: "二极管"),
    onTap: () {
        Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => navigator_tabBar3_1_1(),),
